...
public class TwitchClient {
    private static final String TOKEN = "Bearer ymqpxnfg4l2aco04d6pbz3ubd5kfgu";
    ...
    //先search，再get game list，就可以实现2个API topGames  searchGame
    ...
    //类似postman的功能，返回的数据只取data的部分
    //给一个url返回data 一个string 之后可以复用
